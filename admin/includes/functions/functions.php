...
function GetAllFrom($field, $table, $where = null, $orderBy = null, $ordering = 'DESC',  $type_fetch = null, $limit = null)
{

	global $con;
	$stmt3 = $con->prepare("SELECT $field FROM $table  $where ORDER BY $orderBy  $ordering  $limit ");
	$stmt3->execute();
	if ($type_fetch == null) {
		$row = $stmt3->fetchAll();
	} else {
